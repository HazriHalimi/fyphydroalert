...
<head>
    ...
    <title>Kemaskini Pegawai - HydroAlert</title>
...
<div class="body-content">
    <div class="sec-header">
        <div class="sec-title"><i class="fa-solid fa-user-shield"></i> Kemaskini Maklumat Pegawai</div>
        <a href="admin-officers.jsp" class="btn-cancel" style="padding: 8px 16px;"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
    </div>

    <% if(request.getParameter("error") != null) { %>
        <div class="alert alert-error"><i class="fa-solid fa-triangle-exclamation"></i> Gagal mengemaskini maklumat pegawai. Sila cuba lagi.</div>
    <% } %>

    <div class="form-card">
        <form action="UpdateOfficerServlet" method="post">
            <input type="hidden" name="officerId" value="<%= officerId %>">
            
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label">Nama Pengguna (Username)</label>
                    <input type="text" name="username" class="form-input" value="<%= username %>" required readonly>
                    <span style="font-size:11px;color:var(--muted);margin-top:2px;">Nama pengguna tidak boleh diubah.</span>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Kata Laluan Baru *</label>
                    <input type="password" name="password" class="form-input" value="<%= password %>" required minlength="6">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-input" required>
                        ...
                        <option value="inactive" <%= "inactive".equals(status) ? "selected" : "" %>>Tidak Aktif</option>
                    </select>
                </div>
            </div>
